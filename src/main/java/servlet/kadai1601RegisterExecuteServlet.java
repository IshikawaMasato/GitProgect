...
/**
 * Servlet implementation class kadai1601RegisterExecuteServlet
 */
@WebServlet("/kadai1601RegisterExecuteServlet")
public class kadai1601RegisterExecuteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public kadai1601RegisterExecuteServlet() {
        super();
